...
export const _mock = {
  ...
  spaceName : (index: number) => _spaceNames[index],
  purpose : (index: number) => _purpose[index],
  useDate : (index: number) => _useDate[index],
  startTime : (index: number) => _startTime[index],
  endTime : (index: number) => _endTime[index],
  // sid
  sid: (index: number) => _sid[index],
  // Number
  number: {
